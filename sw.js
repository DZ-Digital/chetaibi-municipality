...
messaging.onBackgroundMessage(payload => {
    ...
    self.registration.showNotification(title || 'بلدية شطايبي', {
        body:    body || '',
        icon:    icon || 'https://cdn.jsdelivr.net/gh/DZ-Digital/chetaibi-assets-v1@main/ui/app-icon.png',
        badge:   'https://cdn.jsdelivr.net/gh/DZ-Digital/chetaibi-assets-v1@main/ui/app-icon.png',
