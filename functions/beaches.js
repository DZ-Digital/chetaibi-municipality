...
<head>
    ...
    <link rel="icon" type="image/png" href="https://cdn.jsdelivr.net/gh/DZ-Digital/chetaibi-assets-v1@main/ui/favicon.png">
    ...
    <div class="bg-white border-b border-sky-100 py-4 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 flex items-center justify-center gap-3">
            <div class="w-16 h-16 rounded-full overflow-hidden shadow-lg flex-shrink-0">
                <img src="https://cdn.jsdelivr.net/gh/DZ-Digital/chetaibi-assets-v1@main/ui/logo.webp" alt="شعار" class="w-full h-full object-cover">
            </div>
